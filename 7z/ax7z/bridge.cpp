...
#include "../../3rdparty/7z/CPP/7zip/ICoder.h"
#include "../../3rdparty/7z/CPP/7zip/UI/Common/DefaultName.h"
#include "../../3rdparty/7z/CPP/7zip/UI/Common/OpenArchive.h"

#ifndef EXCLUDE_COM
#include "../../3rdparty/7z/CPP/Windows/DLL.h"
#endif
...
int GetArchiveInfoEx(LPSTR filename, long len, HLOCAL *lphInf)
{
	...
	if (!MyOpenArchive(codecs, archiveName, archiveFileInfo, &archiveHandler, defaultItemName, passwordEnabled, password)) {
		return SPI_FILE_READ_ERROR;
	}
